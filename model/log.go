...
type Log struct {
	...
	CostQuota         *int   `json:"cost_quota,omitempty" gorm:"default:null"`
...
func formatUserLogs(logs []*Log, startIdx int) {
	for i := range logs {
		...
		if otherMap != nil {
			...
			delete(otherMap, "cost_unknown")
			delete(otherMap, "sell_quota")
			// delete(otherMap, "reject_reason")
			// delete(otherMap, "stream_status")
		}
		logs[i].CostQuota = nil
