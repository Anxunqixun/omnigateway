...
export const STATIC_I18N_KEYS = [
  ...
  // Channel public API docs (labels passed to t at runtime)
  'Text APIs',
  'Image APIs',
  'Video APIs',
  'Audio APIs',
  ...
  'Image edit',
  'Get video result',
  'Fixed to this model ID',
  'Text instruction for image generation',
  'Number of images',
  'Output aspect ratio',
  'Output resolution',
  'Generation quality',
  'Currently returns a URL',
  'Source image URL or file for editing',
  'Text instruction for video generation',
  ...
  '{{MODEL_NAME}} edits an existing image through an OpenAI-compatible API.',
  '{{MODEL_NAME}} provides audio through an OpenAI-compatible API.',
  '{{MODEL_NAME}} provides chat completions through an OpenAI-compatible API.',
  'Submit a video task, then poll the query API until it finishes. Fetch the result from this gateway.',
  'Query the models currently available to your API key and use the returned IDs exactly as shown.',
  'Download the finished video from this gateway after the task succeeds.',
  'Formula',
  'Fixed amount per request',
  'v2 means the number is US dollars, then converted by QuotaPerUnit.',
  'Read a request field',
  'num() takes the first valid number. Missing fields fall back to the next argument.',
  'Charge extra after 5 list items',
  'count("images") is the length of that JSON list. count("n") also works when the client sends a number.',
  'Count nested image parts',
  'The path uses gjson. This counts image_url parts inside messages.',
] as const
