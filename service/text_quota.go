...
func PostTextConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, extraContent []string) {
	...
	if originUsage != nil {
		...
		AttachSettledUsageView(relayInfo, billingUsage)
	...
	costQuota := AttachDualLedger(other, relayInfo, logModel, summary.Quota, tokenParamsFromCounts(summary.PromptTokens, summary.CompletionTokens))
