...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		dataRoute.GET("/profit", middleware.AdminAuth(), controller.GetProfitSummary)

		billingAdminRoute := apiRouter.Group("/billing")
		billingAdminRoute.Use(middleware.AdminAuth())
		{
			billingAdminRoute.POST("/sandbox", controller.PostBillingSandbox)
		}
